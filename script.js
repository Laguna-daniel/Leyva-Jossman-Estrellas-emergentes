...
const lyricsData = [
    ...
    { time: 31, text: "quedaste", artist: "JossMan" },
    { time: 32, text: "aqui marca mi pensamiento", artist: "JossMan" },
    { time: 34, text: "no se que me hiciste", artist: "JossMan" },
    { time: 35, text: "que no olvido ese momento", artist: "JossMan" },
    { time: 37, text: "en el que yo toque tu piel", artist: "JossMan" },
    { time: 38, text: "y tus ojos color miel", artist: "JossMan" },
    { time: 40, text: "me tentaban hacertelo lento", artist: "JossMan" },
    { time: 42, text: "ahora que te tengo alli de frente", artist: "JossMan" },
    { time: 44, text: "me tienes impaciente", artist: "JossMan" },
    { time: 46, text: "y muy loco de la mente", artist: "JossMan" },
    { time: 47, text: "si supieras todo, lo que yo he pensado", artist: "JossMan" },
    { time: 49, text: "rezo por un beso", artist: "JossMan" },
    { time: 50, text: "y por que tu estes a mi lado, baby", artist: "JossMan" },
    { time: 53, text: "hola", artist: "JossMan" },
    { time: 54, text: "beba", artist: "JossMan" },
    { time: 55, text: "dime?", artist: "JossMan" },
    { time: 57, text: "como hago pa olvidarte?", artist: "JossMan" },
    { time: 60, text: "de mi mente", artist: "JossMan" },
    { time: 61, text: "no puedo, sacarte", artist: "JossMan" },
    { time: 63, text: "Hola beba", artist: "JossMan" },
    { time: 65, text: "Hace rato que yo, no se de ti", artist: "JossMan" },
    { time: 68, text: "Te confieso no, te puedo olvidar", artist: "JossMan" },
    { time: 70, text: "desde esa noche, te que conoci-i-i-", artist: "JossMan" },
    { time: 73, text: "Hola beba", artist: "JossMan" },
    { time: 75, text: "Hace rato que yo, no se de ti", artist: "JossMan" },
    { time: 78, text: "Te confieso no, te puedo olvidar", artist: "JossMan" },
    { time: 80, text: "desde esa noche, te que conoci-i-i-", artist: "JossMan" },
...
lyricsData.forEach(item => {
    ...
    } else if (item.artist === 'JossMan') {
        badgeHtml = '<span class="artist-badge badge-JossMan"><i class="fas fa-user-graduate"></i> JOSSMAN</span>';
